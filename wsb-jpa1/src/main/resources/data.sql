...
INSERT INTO PATIENT (id, first_name, last_name, telephone_number, email, patient_number, date_of_birth, description, active)
VALUES
    (1, 'Emma', 'Johnson', '987654321', 'emma.j@example.com', 'P11', '1990-01-01', 'Patient description 1', true),
    (2, 'John', 'Smith', '123456789', 'john.s@example.com', 'P12', '1985-06-15', 'Patient description 2', true),
    (3, 'Olivia', 'Brown', '654321987', 'olivia.b@example.com', 'P13', '1980-03-20', 'Patient description 3', true),
    (4, 'William', 'Davis', '789123456', 'william.d@example.com', 'P14', '1977-12-10', 'Patient description 4', true),
    (5, 'Michael', 'Davis', '583423456', 'michael.william.d@example.com', 'P15', '2000-09-09', 'Patient description 5', true),
    (6, 'Andrew', 'Davis', '889728476', 'andrew.d@example.com', 'P16', '1999-03-15', 'Patient description 6', true),
    (7, 'Sophia', 'Williams', '453214987', 'sophia.w@example.com', 'P17', '1995-11-22', 'Patient description 7', true),
    (8, 'James', 'Jones', '789654123', 'james.j@example.com', 'P18', '1973-05-05', 'Patient description 8', true),
    (9, 'Isabella', 'Miller', '321654987', 'isabella.m@example.com', 'P19', '1988-02-14', 'Patient description 9', true),
    (10, 'Mia', 'Wilson', '456987321', 'mia.w@example.com', 'P20', '1992-07-07', 'Patient description 10', true);
